...
// Математические функции abs, round, ceil, floor, rand, min, max

echo abs(-3000) . '<br>'; // 3000 Абсолютное число
echo round(50.35) . '<br>'; // 50 Округляет до целого
echo ceil(55.11) . '<br>'; // 56 Округляет в большую сторону
echo floor(57.99) . '<br>'; // 57 Округляет в меньшую сторону
echo rand(0, 100) . '<br>'; // Генерирует рандомное число в заданном диапазоне
echo min(3, 5, 77, 55, 997) . '<br>'; // min число
echo max(46, 8448 ,53, 5867,3) . '<br>'; // max число
